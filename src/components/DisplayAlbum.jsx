...
const DisplayAlbum = () => {
  ...
  return (
    <>
      <NavBar />
      <div className="mt-5 d-flex flex-column flex-md-row align-items-md-end gap-4">
      ...
      <div className="row mt-4 mb-4 px-2 text-muted">
      ...
      <hr />
      {
        songsData.map((item, index) => (
          <div 
            ...
            key={index} 
            className="row p-2 align-items-center text-muted hover-bg-light cursor-pointer"
          >
